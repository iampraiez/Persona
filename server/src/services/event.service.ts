...
export class EventService {
      ...
      data: {
        ...
        focusDuration:
          focusDuration !== undefined
            ? typeof focusDuration === "string"
              ? parseInt(focusDuration)
              : focusDuration
            : undefined,
      },
    });
  ...
  static async copyEvents(
    userId: string,
    data: { sourceStart: string; sourceEnd: string; targetStart: string },
  ) {
