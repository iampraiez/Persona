...
router.get("/", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Get Events Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to get events"),
        });
    }
});
router.get("/upcoming", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Get Upcoming Events Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to get upcoming events"),
        });
    }
});
router.get("/date", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Get Events by Date Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to get events"),
        });
...
router.post("/", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Create Event Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to create event"),
        });
    }
});
router.put("/:id", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Update Event Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to update event"),
        });
    }
});
router.put("/:id/skip", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Skip Event Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to skip event"),
        });
    }
});
router.delete("/:id", async (req, res) => {
    try {
        ...
        logger_utils_1.logger.error(`Delete Event Error: ${error}`);
        res.status(500).json({
            data: null,
            error: (0, error_util_1.errorWrapper)(error, "Failed to delete event"),
        });
    }
});
